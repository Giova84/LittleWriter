...
const QString rsrcPath = ":/images/haiku";
...
bool TextEdit::maybeSave()
{
    ...
    ret = QMessageBox::warning(this, tr("Little Writer"),
...
void TextEdit::setCurrentFileName(const QString &fileName)
{
    ...
    setWindowTitle(tr("%1[*] - %2").arg(shownName).arg(tr("Little Writer")));
...
//QDesktopServices::openUrl(QUrl("http://qt-project.org/doc/qt-4.8/demos-textedit.htm"));
...
void TextEdit::colorChanged(const QColor &c)
{
    ...
    //actionHighlightedTextColor->setIcon(pix);
